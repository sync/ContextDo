#import "CTXDOLoginButton.h"


@implementation CTXDOLoginButton
...
{	
	...
	UIImage *image = [UIImage imageNamed:@"btn_std_login_off.png"];
	image = [image stretchableImageWithLeftCapWidth:(image.size.width / 2.0) - 1.0 topCapHeight:0.0];
	[self setBackgroundImage:image forState:UIControlStateNormal];
	
	UIImage *highlightedImage = [UIImage imageNamed:@"btn_std_login_touch.png"];
